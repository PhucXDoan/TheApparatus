...
struct USBMSMasterBootRecord // See: "Structure of a classical generic MBR" @ Source(16).
{
...
struct USBMSFAT32BootSector // See: "Boot Sector and BPB Structure" @ Source(15) @ Page(9).
{
	u8   BS_jmpBoot[3];    // Best as { 0xEB, 0x00, 0x90 }.
	char BS_OEMName[8];    // Best as "MSWIN4.1".
	...
	u16  BPB_RsvdSecCnt;   // Must be non-zero. Typically 32.
	u8   BPB_NumFATs;      // Amount of redundant sectors to hold the FATs. Best as 2.
	u16  BPB_RootEntCnt;   // Must be zero.
	u16  BPB_TotSec16;     // Must be zero.
	u8   BPB_Media;        // Best as 0xF8 for "fixed (non-removable) media". Generally ignored, but must be "in the low byte of the FAT[0] entry." TODO This is kinda inconsistent with SCSI data saying the media is removable.
	...
	u32  BPB_RootClus;     // Cluster number of the first cluster of the root directory; usually 2.
...
static const u8 USB_MS_LOGICAL_BLOCKS[][512] PROGMEM =
	{
		[0] =
			{
				...
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x24, 0x9F, 0xF2, 0x1C, 0x00, 0x00, 0x80, 0x01,
				0x02, 0x00, 0x0C, 0xFE, 0xFF, 0xD2, 0x40, 0x00, 0x00, 0x00, 0xC0, 0xFF, 0xEF, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		...
		[1] =
			{
				...
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x72, 0x72, 0x41, 0x61, 0xF3, 0xEF, 0x1D, 0x00, 0x07, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x55, 0xAA,
			},

		[6] =
			{
				0xEB, 0x58, 0x90, 0x4D, 0x53, 0x44, 0x4F, 0x53, 0x35, 0x2E, 0x30, 0x00, 0x02, 0x08, 0x40, 0x08,
				0x02, 0x00, 0x00, 0x00, 0x00, 0xF8, 0x00, 0x00, 0x3F, 0x00, 0xFF, 0x00, 0x40, 0x00, 0x00, 0x00,
				0xC0, 0xFF, 0xEF, 0x00, 0xE0, 0x3B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
				0x01, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x80, 0x00, 0x29, 0x37, 0x08, 0x20, 0xEA, 0x4E, 0x4F, 0x20, 0x4E, 0x41, 0x4D, 0x45, 0x20, 0x20,
...
/*
	...
	*Source(6) := USB CDC Specification v1.1 (Dated: January 19, 1999).
	...
	Source(15) := Microsoft Extensible Firmware Initiative FAT32 File System Specification (Dated: December 6, 2000).
