...
#define WORDGAME_XMDT(X, Y) /* There's no good way to determine the language of Anagrams perfectly, so we will always assume it's English and have the test region all be zero. */ \
	/*    Names                                     | Language | Max Word Length | Sentinel Letter | Board Position | Board Dim (slots) | Slot Dim | Uncompressed Slot Stride | Compressed Slot Stride | Test Region Position | Test Region Dimensions | Test Region RGB       | Excluded Slot Coordinates */ \
		...
		X(anagrams_english_7, "Anagrams (EN, 7)"    , english  , 7               , Letter_z + 1    ,  29, 413       , 7, 1              , 106      , 168                      , 101                    ,   32,  656           , 256,  16               , 0.2936, 0.2699, 0.3658                                         ) \
		...
		X(wordhunt_4x4      , "WordHunt (4x4)"      , english  , 15              , Letter_z + 1    , 196, 608       , 4, 4              , 142      , 212                      ,  96                    ,  128,  770           , 900,  16               , 0.2204, 0.2775, 0.2089                                         ) \
		X(wordhunt_o        , "WordHunt (O)"        , english  , 15              , Letter_z + 1    , 141, 550       , 5, 5              , 126      , 191                      ,  97                    ,  512,  926           , 128, 128               , 0.4752, 0.6331, 0.4367, Y(0, 0) Y(0, 4) Y(4, 0) Y(4, 4) Y(2, 2)) \
		X(wordhunt_x        , "WordHunt (X)"        , english  , 15              , Letter_z + 1    , 141, 550       , 5, 5              , 126      , 191                      ,  97                    ,  500,  554           , 128, 128               , 0.4356, 0.5768, 0.4018, Y(0, 2) Y(2, 0) Y(4, 2) Y(2, 4)        ) \
		X(wordhunt_5x5      , "WordHunt (5x5)"      , english  , 15              , Letter_z + 1    , 141, 550       , 5, 5              , 126      , 191                      ,  97                    , 1050,  468           ,  64,  64               , 0.4641, 0.6239, 0.4251                                         ) \
		X(wordbites         , "WordBites"           , english  , 9               , Letter_z + 1    ,  44, 462       , 8, 9              , 102      , 140.5                    ,  88                    ,  400,  218           ,  64,  64               , 0.2675, 0.3956, 0.5153                                         )
